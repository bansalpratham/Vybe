...
function EditProfile() {
  ...
  return (
    <div className='w-full min-h-screen bg-black flex items-center flex-col gap-5'>
       <div className='w-full h-20 flex items-center gap-5 px-5'> <IoMdArrowBack  className='text-white w-6.25 h-6.25 cursor-pointer' onClick={()=>navigate(`/profile/${userData.userName}`)} />
